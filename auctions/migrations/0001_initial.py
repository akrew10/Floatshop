# Generated by Django 4.2.3 on 2023-08-26 01:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wear', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='wear', to='auctions.wear')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('comments', models.ManyToManyField(blank=True, related_name='comments', to='auctions.listing')),
            ],
        ),
    ]
